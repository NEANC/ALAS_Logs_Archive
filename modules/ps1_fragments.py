...
"""自更新 PowerShell 脚本片段生成器。"""

import textwrap


def generate_sha256_function_ps1() -> str:
    """生成 SHA256 多路径 fallback 函数。"""
...
def generate_common_base_functions_ps1() -> str:
    """生成 Helper.ps1 与 Update.ps1 共享的基础函数。"""
    return textwrap.dedent(r'''
